...
namespace VTMES3_RE.Common
{
    ...
    {
        public static string CorpID = "VT";
        ...
        public static string FactoryId = string.Empty;     // 로그인한 사용자 이름
        public static string FactoryName = string.Empty;     // 로그인한 사용자 이름
        ...
        public static string DBServer = "10.10.50.53";
