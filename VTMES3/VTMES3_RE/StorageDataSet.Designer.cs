...
namespace VTMES3_RE.StorageDataSetTableAdapters {
...
SELECT CorpId, ReportId, ReportName, LayoutData, SubYn, RevisionName, Bigo, CreId, CreIP, CreDt, ModId, ModIP, ModDt FROM ReportItem WHERE (ReportId = @ReportId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT Bigo, CorpId, CreDt, CreIP, CreId, LayoutData, ModDt, ModIP, ModId, Report" +
                "Id, ReportName, RevisionName, SubYn, ReportName OldName FROM ReportItem WHERE (C" +
                "orpId = @pCorpId)";
        ...
        public virtual int Fill(StorageDataSet.ReportItemDataTable dataTable, string pCorpId) {
        ...
        public virtual StorageDataSet.ReportItemDataTable GetData(string pCorpId) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((pCorpId == null)) {
                throw new global::System.ArgumentNullException("pCorpId");
            }
            ...
            StorageDataSet.ReportItemDataTable dataTable = new StorageDataSet.ReportItemDataTable();
        ...
        public virtual int FillByList(StorageDataSet.ReportItemDataTable dataTable, string pCorpId) {
        ...
        public virtual StorageDataSet.ReportItemDataTable GetDataByList(string pCorpId) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((pCorpId == null)) {
                throw new global::System.ArgumentNullException("pCorpId");
            }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(StorageDataSet.ReportItemDataTable dataTable) {
