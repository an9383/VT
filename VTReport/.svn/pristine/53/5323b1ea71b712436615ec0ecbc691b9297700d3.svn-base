<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DashboardView_BuiltIn_DD.aspx.cs" Inherits="View_Dashboard_BuiltInBoard_DashboardView_BuiltIn_DD" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function onDashboardInitialized(sender, args) {
            ...
            setInterval(Event_Refresh, 60000);
        }
