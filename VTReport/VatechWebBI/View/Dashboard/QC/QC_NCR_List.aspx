<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QC_NCR_List.aspx.cs" Inherits="View_Dashboard_QC_QC_NCR_List" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function onDashboardTitleToolbarUpdated(sender, args) {
            ...
            addItem(items, "customReportIcon", OpenPop_OQC, "상세보기");
        }
        ...
        function OpenPop_OQC() {
            ...
            var url = "../../ReportView.aspx?reportid=11" + urlParam;
