<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SW_LockKey_Label.aspx.cs" Inherits="View_Dashboard_SW_LockKey_Label" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function onDashboardTitleToolbarUpdated(sender, args) {
            ...
            addItem(items, "customReportIcon1", OpenPop_SelReport, "선택 라벨 인쇄");
            addItem(items, "customReportIcon2", OpenPop_AllReport, "전체 라벨 인쇄");
        }
        ...
        function OpenPop_SelReport() {
            ...
            var url = "../ReportView.aspx?reportid=19" + urlParam;
