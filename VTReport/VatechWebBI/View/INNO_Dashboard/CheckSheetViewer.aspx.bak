<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CheckSheetViewer.aspx.cs" Inherits="View_INNO_Dashboard_CheckSheetViewer" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function OpenPop_OQC() {
            const arrKey = ['ContainerName', 'TubeNo', 'Gubun'];
            ...
            var url = "../ReportView.aspx?reportid=15" + urlParam;
